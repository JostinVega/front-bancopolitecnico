...
export class ActualizarInformacionComponent {
  ...
  /*async sendSecurityCode(email: string, phoneNumber: string): Promise<void> {
    try {
      const response = await this.http.post('https://back-enviar-codigos-validacion.vercel.app/send-code', { email, phoneNumber }).toPromise();
    ...
    async sendSecurityCode(email: string, phoneNumber: string): Promise<void> {
      try {
        ...
        const firstResponse = await this.http.post('https://back-enviar-codigos-validacion.vercel.app/send-code', { email, phoneNumber }).toPromise();
        console.log('Primer código de seguridad enviado:', firstResponse);
    
        // Reenvío automático del código de verificación
        const secondResponse = await this.http.post('https://back-enviar-codigos-validacion.vercel.app/send-code', { email, phoneNumber }).toPromise();
      ...
      this.accountService.getUserInfo(numeroIdentidad).subscribe(
        userInfo => {
          ...
          //if (email && phoneNumber) {
            //this.http.post('https://back-enviar-codigos-validacion.vercel.app/send-code', { email, phoneNumber }).subscribe(
          if (email && phoneNumber) {
            this.http.post('https://back-enviar-codigos-validacion.vercel.app/send-code', { email, phoneNumber}).subscribe(
              (response: any) => {
                console.log('Código de seguridad enviado:', response);
