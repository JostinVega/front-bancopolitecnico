...
export class VerifyChangePasswordComponent {
  ...
  */
  ...
  onSubmit(): void {
    ...
    this.http.post('https://back-enviar-codigos-validacion.vercel.app/verify-code', { email: this.email, code }).subscribe(
      (response: any) => {
...
    }
  ...
  resendCode(): void {
    ...
    this.http.post('https://back-enviar-codigos-validacion.vercel.app/send-code', { email: this.email, phoneNumber: this.phoneNumber }).subscribe(
      (response: any) => {
