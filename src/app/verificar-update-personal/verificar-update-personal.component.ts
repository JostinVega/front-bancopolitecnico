...
export class VerificarUpdatePersonalComponent {
  ...
  async onSubmit(): Promise<void> {
    ...
    try {
      const response: any = await this.http.post('https://back-enviar-codigos-validacion.vercel.app/verify-code', { email: this.oldEmail, code }).toPromise();
...
    }
  ...
  async resendCode(): Promise<void> {
    try {
      const response = await this.http.post('https://back-enviar-codigos-validacion.vercel.app/send-code', { email: this.oldEmail, phoneNumber: this.oldPhone }).toPromise();
